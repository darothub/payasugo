...
class DatabaseTest: XCTestCase {
    ...
    func testThatObjectIsCreatedFromApiResponse() {
        ...
        XCTAssertEqual(realm.objects(Country.self).first?.country, "Botswana",
