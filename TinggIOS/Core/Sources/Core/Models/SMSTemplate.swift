...
public class SMSTemplate: Object,  ObjectKeyIdentifiable, Codable {
    ...
    init(
        template: String?, regex: String?, serviceID: String?,
         serviceCode: String?, clientID: String?, countryID: String?,
         regexType: String?, sourceAddress: String?, keywords: String?,
         mappingValues: String?, messageType: String?, accountNumberRegex: String?,
         parseType: String?, serviceCategoryID: String?, service: String?,
         isContracted: Bool, accountSanitizerRegex: String?, smsTemplateType: String?,
         associativeSourceAddress: String?
    ) {
