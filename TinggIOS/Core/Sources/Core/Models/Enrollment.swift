...
public class Enrollment: Object,  ObjectKeyIdentifiable, Codable {
    ...
    init(
        accountAlias: String?, accountNumber: String?, hubServiceID: String?,
        clientProfileAccountID: String?, isExplicit: String?, isContracted: Bool,
        dateLastRefreshed: String?, unknownMerchantID: String?, extraData: String?,
        accountStatus: String?, accountID: String?, isFetchingBill: Bool,
        confirmStatus: String?, merchantService: MerchantService?
    ) {
