...
public class Highlight: Object, ObjectKeyIdentifiable, Codable {
    ...
    // swiftlint:disable all
//    init(
//        activeStatus: String?, title: String?, actionName: String?,
//         highlightDESCRIPTION: String?, hasDeepLink: String?, categoryID: String?,
//         serviceID: String?, imageURL: String?, deepLink: String?,
//         dynamicLink: String?, amount: String?, priority: String?
//    ) {
