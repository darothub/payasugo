...
// MARK: - Country
public class CountryInfo: Object, ObjectKeyIdentifiable, Codable {
...
//        case isSecureCardPayment = "IS_SECURE_CARD_PAYMENT"
    ...
    func convertToDTO() -> CountriesInfoDTO {
        ...
        let newSelf = self.freeze()
        countriesInfo.name  = newSelf.name
        countriesInfo.countryCode  = newSelf.countryCode
        countriesInfo.countryURLNew  = newSelf.countryURLNew
        countriesInfo.status  = newSelf.status
        countriesInfo.currency  = newSelf.currency
        countriesInfo.mulaClientID  = newSelf.mulaClientID
        countriesInfo.countryMobileRegex  = newSelf.countryMobileRegex
        countriesInfo.genericAccountNumberRegex  = newSelf.genericAccountNumberRegex
    //     countriesInfo.extractSMSOnProfiling = newSelf.extractSMSOnProfiling
        countriesInfo.countryCurrencyRegex  = newSelf.countryCurrencyRegex
    //     countriesInfo.excludedSMSSourceAddresses = newSelf.excludedSMSSourceAddresses
        countriesInfo.countryDialCode  = newSelf.countryDialCode
    //     countriesInfo.confirmedAccountLimits  = newSelf.confirmedAccountLimits
        countriesInfo.hotlineAppID  = newSelf.hotlineAppID
        countriesInfo.hotlineAppKey  = newSelf.hotlineAppKey
        countriesInfo.freshchatAppID  = newSelf.freshchatAppID
        countriesInfo.freshchatAppKey  = newSelf.freshchatAppKey
        countriesInfo.faqURL  = newSelf.faqURL
        countriesInfo.tacURL  = newSelf.tacURL
        countriesInfo.alphanumericRegexes  = newSelf.alphanumericRegexes
        countriesInfo.minimumProfiledAccounts  = newSelf.minimumProfiledAccounts
        countriesInfo.smsProfilingTimeout  = newSelf.smsProfilingTimeout
        countriesInfo.roundUpAmounts  = newSelf.roundUpAmounts
        countriesInfo.maximumCards  = newSelf.maximumCards
        countriesInfo.countryFlag  = newSelf.countryFlag
        countriesInfo.hasWallet  = newSelf.hasWallet
        countriesInfo.hasGroups  = newSelf.hasGroups
        countriesInfo.hasFloatingButton  = newSelf.hasFloatingButton
    //     countriesInfo.hasDiscover = newSelf.hasDiscover
        countriesInfo.useSmileSDK  = newSelf.useSmileSDK
        countriesInfo.hasReferral  = newSelf.hasReferral
    //     countriesInfo.isManualKycRegistration = newSelf.isManualKycRegistration
        countriesInfo.countrySourceAddresses  = newSelf.countrySourceAddresses
        countriesInfo.isDefault  = newSelf.isDefault
        countriesInfo.successCallBackURL  = newSelf.successCallBackURL
        countriesInfo.payerClientCode  = newSelf.payerClientCode
    //     countriesInfo.isSecureCardPayment  = newSelf.isSecureCardPayment
        countriesInfo.failedCallBackURL  = newSelf.failedCallBackURL
        countriesInfo.webCheckoutURL  = newSelf.webCheckoutURL
        countriesInfo.clevertapAccountID  = newSelf.clevertapAccountID
        countriesInfo.clevertapToken  = newSelf.clevertapToken
        countriesInfo.showAssist  = newSelf.showAssist
        countriesInfo.mulaAssistInterestType  = newSelf.mulaAssistInterestType
        countriesInfo.mulaAssistDurationType  = newSelf.mulaAssistDurationType
        countriesInfo.mulaAssistInterestRate  = newSelf.mulaAssistInterestRate
        countriesInfo.mulaAssistDuration  = newSelf.mulaAssistDuration
        countriesInfo.mulaAssistLoanTermDuration  = newSelf.mulaAssistLoanTermDuration
        countriesInfo.accessKey  = newSelf.accessKey
        countriesInfo.checkoutServiceCode  = newSelf.checkoutServiceCode
        countriesInfo.webHookURL  = newSelf.webHookURL
        countriesInfo.fetchBearerTokenURL  = newSelf.fetchBearerTokenURL
        countriesInfo.privacyPolicyURL  = newSelf.privacyPolicyURL
        countriesInfo.activeCountry =  newSelf.activeCountry
