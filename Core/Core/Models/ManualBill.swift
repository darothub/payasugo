...
public class ManualBill: Object,  ObjectKeyIdentifiable, Codable {
    ...
    @Persisted public var paymentOptions: List<PayerOptions>
    ...
    init(manualBillID: String?, merchantAccountNumber: String?, merchantName: String?, billReminderFrequency: String?, billAmount: String?, paymentOptions: RealmSwift.List<PayerOptions>, billDueDate: String?, isBillSearch: String?, categoryID: String?, accountPayload: String?, category: Category?) {
